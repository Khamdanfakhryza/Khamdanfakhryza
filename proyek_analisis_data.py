...
# 2. Masukkan ID folder dari link yang Anda bagikan
folder_id = "1OW5S61s1FTawbGi1bkm2wHVIU50epi0s"
destination_folder = "/content/air_quality_data"

# 3. Gunakan gdown untuk mendownload seluruh file dalam folder
!pip install --upgrade --quiet gdown
!gdown --folder --id {folder_id} -O {destination_folder}

# 4. Pastikan folder sudah ada dan tentukan lokasi file
locations = [
    "Aotizhongxin", "Changping", "Dingling", "Dongsi", "Guanyuan", "Gucheng",
    "Huairou", "Nongzhanguan", "Shunyi", "Tiantan", "Wanliu", "Wanshouxigong"
]

# 5. Membaca dataset ke dalam dictionary
dataframes = {}
for loc in locations:
    file_path = os.path.join(destination_folder, f"PRSA_Data_{loc}_20130301-20170228.csv")

    if Path(file_path).exists():  # Cek apakah file ada
        dataframes[loc] = pd.read_csv(file_path)
        print(f"Loaded {loc} successfully!")
    else:
        print(f"File for {loc} not found!")
...
df_Aotizhongxin = pd.read_csv('/content/air_quality_data/PRSA_Data_Aotizhongxin_20130301-20170228.csv')
df_Changping = pd.read_csv('/content/air_quality_data/PRSA_Data_Changping_20130301-20170228.csv')
df_Dingling = pd.read_csv('/content/air_quality_data/PRSA_Data_Dingling_20130301-20170228.csv')
df_Dongsi = pd.read_csv('/content/air_quality_data/PRSA_Data_Dongsi_20130301-20170228.csv')
df_Guanyuan = pd.read_csv('/content/air_quality_data/PRSA_Data_Guanyuan_20130301-20170228.csv')
df_Gucheng = pd.read_csv('/content/air_quality_data/PRSA_Data_Gucheng_20130301-20170228.csv')
df_Huairou = pd.read_csv('/content/air_quality_data/PRSA_Data_Huairou_20130301-20170228.csv')
df_Nongzhanguan = pd.read_csv('/content/air_quality_data/PRSA_Data_Nongzhanguan_20130301-20170228.csv')
df_Shunyi = pd.read_csv('/content/air_quality_data/PRSA_Data_Shunyi_20130301-20170228.csv')
df_Tiantan = pd.read_csv('/content/air_quality_data/PRSA_Data_Tiantan_20130301-20170228.csv')
df_Wanliu = pd.read_csv('/content/air_quality_data/PRSA_Data_Wanliu_20130301-20170228.csv')
df_Wanshouxigong = pd.read_csv('/content/air_quality_data/PRSA_Data_Wanshouxigong_20130301-20170228.csv')

import pandas as pd
import os

# Pastikan lokasi folder sesuai dengan lokasi tempat file diunduh oleh gdown
folder_path = "/content/air_quality_data"
...
file_id = '1oR1RCUCwbkK3RZlIwqeXtwTY7csJXgat'
# Destination path
destination = '/content/air_quality_data/PRSA_Data_Aotizhongxin_20130301-20170228.csv'
...
# Load the CSV files into DataFrames
df_Aotizhongxin = pd.read_csv('/content/air_quality_data/PRSA_Data_Aotizhongxin_20130301-20170228.csv')
# Repeat for other data files (assuming paths are known for other stations)
